          ...
          <Card className="w-full max-w-5xl border-slate-800 bg-slate-900/50 overflow-hidden shadow-2xl hover:shadow-indigo-500/10 transition-all backdrop-blur-sm">
            <div className="aspect-video bg-gradient-to-br from-slate-900 to-slate-800 flex items-center justify-center relative overflow-hidden group">
              ...
              <button className="relative z-10 group/btn">
                <div className="absolute inset-0 bg-indigo-500/30 rounded-full scale-0 group-hover/btn:scale-150 transition-transform duration-500 blur-xl" />
                <div className="relative bg-gradient-to-r from-indigo-600 to-purple-600 rounded-full p-6 shadow-2xl shadow-indigo-500/50 group-hover/btn:scale-110 transition-transform">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, index) => {
            ...
            return (
              <Card 
                key={index}
                className={`border-slate-800 bg-slate-900/50 p-8 hover:bg-slate-800/80 transition-all duration-500 backdrop-blur-sm group cursor-pointer ${
